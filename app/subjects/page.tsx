...
export default function SubjectsPage() {
  ...
  const handleDrop = (e: React.DragEvent) => {
    ...
    setUploadedFiles((prev) => ({
      ...prev,
      [activeSubjectId]: [...(prev[activeSubjectId] || []), ...newFiles],
    }))
  }
        ...
        {displayedSubjects.map((subject) => {
          ...
          return (
            <button
              ...
              className={`glass group flex flex-col gap-4 rounded-2xl p-5 text-left transition-all duration-300 hover:scale-[1.01] ${
                isSelected
